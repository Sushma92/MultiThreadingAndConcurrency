package com.sushma.java.publisher_subsciber;

import java.util.Random;
import java.util.concurrent.TimeUnit;

import com.sushma.java.publisher_subsciber.WeatherForecastExample.WeatherForecast;
...
public class WeatherForecastExample {
	...
	public static class WeatherForecast {
		...
		private static final String[] allWeatherConditions = new String[] { "cloudy", "sunny", "semi-cloudy", "rain",
				"thunderstorms" };
